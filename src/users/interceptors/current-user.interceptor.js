...
var CurrentUserInterceptor = /** @class */ (function () {
    function CurrentUserInterceptor(userService) {
        this.userService = userService;
    }
    CurrentUserInterceptor.prototype.intercept = function (context, next) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2: return [2 /*return*/, next.handle()];
                }
            });
        });
    };
